...
/// </remarks>
public static unsafe class ManagedENet
{
    ...
    public static void Startup(ENetStartupOptions startupOptions)
    {
        ...
        else
        {
            ...
            var callbacks = new NativeENetCallbacks
            {
    ...
    {
        throw new OutOfMemoryException("ENet ran out of memory.");
    }
    ...
    private static IntPtr MemAllocCallback(UIntPtr size)
    {
        ...
        if (allocator != null) return allocator.Allocate((int)size.ToUInt32());
