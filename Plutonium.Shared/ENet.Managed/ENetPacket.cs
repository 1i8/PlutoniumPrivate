...
public unsafe readonly struct ENetPacket : IEquatable<ENetPacket>
{
    ...
    public int ReferenceCount
    {
        get
        {
            ...
            return (int)m_Native->ReferenceCount;
        }
    }
    ...
    public NativeENetPacket* GetNativePointer()
    {
        return m_Native;
    }
    ...
    public ENetPacket(int dataLength, ENetPacketFlags flags)
    {
        ...
        m_Native = LibENet.PacketCreate(IntPtr.Zero, (UIntPtr)dataLength, flags);
    }
    ...
    public ENetPacket(Span<byte> data, ENetPacketFlags flags)
    {
        fixed (byte* p = data)
        {
            m_Native = LibENet.PacketCreate(new IntPtr(p), (UIntPtr)data.Length, flags);
        }
    }
    ...
    public void Resize(int dataLength)
    {
        ...
        if (LibENet.PacketResize(m_Native, (UIntPtr)dataLength) < 0)
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(ENetPacket left, ENetPacket right)
    {
