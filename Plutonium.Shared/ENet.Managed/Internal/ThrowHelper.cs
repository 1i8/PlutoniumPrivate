...
internal static class ThrowHelper
{
    ...
    public static void ThrowCurrentArchitectureNotSupportedYet()
    {
        throw new PlatformNotSupportedException(
            $"Architecture {RuntimeInformation.OSArchitecture} is not supported yet on current platform.");
    }
    ...
    {
        throw new NullReferenceException($"{nameof(ENetAllocator)} reference is null unexpectedly");
    }
    ...
    public static void ThrowENetLibraryProcNotFound(string procName, int lastError)
    {
        throw new DllNotFoundException(
            $"Procedure '{procName}' doesn't found within ENet dynamic library. (LastError: {lastError})");
    }
