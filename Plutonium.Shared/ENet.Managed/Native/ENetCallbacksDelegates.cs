...
public unsafe delegate UIntPtr ENetCompressCallback(IntPtr context, NativeENetBuffer* inBuffers, UIntPtr inBufferCount,
    UIntPtr inLimit, IntPtr outData, UIntPtr outLimit);

[UnmanagedFunctionPointer(LibENet.ENetCallingConvention)]
public delegate UIntPtr ENetDecompressCallback(IntPtr context, IntPtr inData, UIntPtr inLimit, IntPtr outData,
    UIntPtr outLimit);
...
[UnmanagedFunctionPointer(LibENet.ENetCallingConvention)]
public delegate void ENetPacketFreeCallback(IntPtr data);
