...
public sealed class ENetAsyncPeer
{
    ...
    private readonly TaskCompletionSource<uint> m_DisconnectCompletionSource =
    ...
    /// </summary>
    /// <remarks>
    ///     This is the data that is passed to <see cref="ENetHost.Connect(IPEndPoint, byte, uint)" /> or it's async
    ///     counterpart locally or remotely.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    ///     The disconnection data is the parameter passed to <see cref="ENetPeer.Disconnect(uint)" /> or
    ///     <see cref="DisconnectAsync(uint)" />.
    /// </remarks>
    ...
    /// <remarks>
    ///     ENet: <br />
    ///     The foreign host represented by the peer is not notified of the disconnection and will timeout on its connection to
    ///     the local host. <br />
    ///     Async: <br />
    ///     <see cref="Connection" />, <see cref="Disconnection" /> and <see cref="ReceiveAsync(CancellationToken)" /> will
    ///     throw <see cref="ENetAsyncPeerResetException" />.
    /// </remarks>
    ...
    /// <remarks>
    ///     Makes <see cref="ReceiveAsync(CancellationToken)" /> throw <see cref="ENetAsyncPeerDisconnectedException" /> upon
    ///     disconnection. <br />
    ...
    ///     Subsequent <see cref="ReceiveAsync(CancellationToken)" /> calls throw
    ///     <see cref="ENetAsyncPeerDisconnectedException" />.
    /// </remarks>
    ...
    /// <remarks>
    ///     From offical doc:
    ///     Ping requests factor into the mean round trip time as designated by the roundTripTime field in the ENetPeer
    ///     structure.
    ...
    /// </summary>
    /// <param name="timeout">
    ///     The interval at which to send pings; defaults to ENET_PEER_PING_INTERVAL if
