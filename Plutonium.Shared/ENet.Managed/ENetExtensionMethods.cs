...
public static unsafe class ENetExtensionMethods
{
    ...
    /// <remarks>
    ///     If the data type differs from what was supplied to <see cref="SetUserData{TData}(ENetPeer, TData)" /> then return
    ///     value becomes false.
    /// </remarks>
    ...
    /// <returns>Returns true if the user-data found; otherwise false.</returns>
    /// <remarks>
    ///     If the data type differs from what was supplied to <see cref="SetUserData{TData}(ENetPacket, TData)" /> then return
    ///     value becomes false.
    /// </remarks>
